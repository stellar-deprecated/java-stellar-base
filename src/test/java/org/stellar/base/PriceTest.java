...
public class PriceTest extends TestCase {
    @Test
    public void testRationalApproximation() {
        PriceTestCase[] tests = {
                ...
                new PriceTestCase(0.0, new Price(0,1)),
        ...
        for (PriceTestCase test : tests) {
            Price price = Price.rationalApproximation(test.input);
            assertEquals(test.expectedPrice.getDenominator(), price.getDenominator());
            assertEquals(test.expectedPrice.getNumerator(), price.getNumerator());
        }
    }
    ...
    private class PriceTestCase {
        ...
        public PriceTestCase(double input, Price expectedPrice) {
            this.input = input;
