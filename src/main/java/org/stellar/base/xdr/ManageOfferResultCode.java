...
public enum ManageOfferResultCode  {
  ...
  MANAGE_OFFER_NOT_FOUND(-9),
  MANAGE_OFFER_MISMATCH(-10),
  MANAGE_OFFER_LOW_RESERVE(-11),
  ;
  private int mValue;
  ...
  static ManageOfferResultCode decode(XdrDataInputStream stream) throws IOException {
    ...
    switch (value) {
      ...
      case -9: return MANAGE_OFFER_NOT_FOUND;
      case -10: return MANAGE_OFFER_MISMATCH;
      case -11: return MANAGE_OFFER_LOW_RESERVE;
      default:
